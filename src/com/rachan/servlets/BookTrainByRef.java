...
public class BookTrainByRef extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		pw.println("<div class='tab'>" + "<form action='payment' method='post'>" + "<table>"
				...
				+ "<select name='berth'><option value='NO'>No Preference</option><option value='LB'>Lower Berth(LB)</option><option value='UB'>Upper Berth(UB)</option><option value='MB'>Middle Berth(MB)</option><option value=W'>Window side</option></select>"
				+ "</td></tr>" + "</table></div>"
